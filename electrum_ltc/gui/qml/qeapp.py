...
from electrum_ltc import version, constants
...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, config, daemon, plugins):
        ...
        qmlRegisterType(QETxRbfFeeBumper, 'org.electrum_ltc', 1, 0, 'TxRbfFeeBumper')
        qmlRegisterType(QETxCpfpFeeBumper, 'org.electrum_ltc', 1, 0, 'TxCpfpFeeBumper')
        qmlRegisterType(QETxCanceller, 'org.electrum_ltc', 1, 0, 'TxCanceller')
